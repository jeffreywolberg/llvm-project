...
@.str.5 = private unnamed_addr constant [11 x i8] c"After: %s\0A\00", align 1
@.str.6 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1

; Function Attrs: norecurse nounwind readnone
define dso_local double @foo(i32 %0, double %1) local_unnamed_addr #0 {
...
define dso_local i32 @foo2(i32 %0, %struct.my_struct* %1, i8* nocapture readnone %2, i16* nocapture readnone %3, double %4) local_unnamed_addr #1 {
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 1 dereferenceable(6) %6, i8* nonnull align 1 dereferenceable(6) getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i64 6, i1 false) #4
...
define dso_local i32 @main() local_unnamed_addr #1 {
  ...
  %4 = getelementptr inbounds %struct.my_struct, %struct.my_struct* %1, i64 0, i32 0
  store i32 10, i32* %4, align 4, !tbaa !2
  %5 = getelementptr inbounds %struct.my_struct, %struct.my_struct* %1, i64 0, i32 1, i64 0
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(5) %5, i8* nonnull align 1 dereferenceable(5) getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i64 5, i1 false) #4
  %6 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i8* nonnull %5) #4
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(6) %5, i8* nonnull align 1 dereferenceable(6) getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i64 6, i1 false) #4
  %7 = load i32, i32* %4, align 4, !tbaa !2
  %8 = add nsw i32 %7, 15
  %9 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([11 x i8], [11 x i8]* @.str.5, i64 0, i64 0), i8* nonnull %5)
  %10 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.6, i64 0, i64 0), i32 %8)
